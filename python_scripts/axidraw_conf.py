...
speed_pendown = 95      # Maximum plotting speed, when pen is down (1-100). Default 25
speed_penup = 110        # Maximum transit speed, when pen is up (1-100). Default 75
accel = 75              # Acceleration rate factor (1-100). Default 75

pen_pos_up = 80         # Height of pen when raised (0-100). Default 60
pen_pos_down = 30       # Height of pen when lowered (0-100). Default 30

pen_rate_raise = 100     # Rate of raising pen (1-100). Default 75
pen_rate_lower = 80     # Rate of lowering pen (1-100). Default 50

pen_delay_up = -2        # Optional delay after pen is raised (ms). Default 0
pen_delay_down = -2      # Optional delay after pen is lowered (ms). Default 0

const_speed = False     # Use constant velocity mode when pen is down. Default False
report_time = True     # Report time elapsed. Default False
...
hiding = True          # Hidden-line removal. Default: False
...
min_gap = 0.03     # Automatic path joining threshold, inches. Default: 0.006
...
curve_tolerance = 0.006 # Curve representation tolerance, inches. Default: 0.002 (0.05 mm)
